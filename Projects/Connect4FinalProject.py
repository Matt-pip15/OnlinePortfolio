...
def bladeSelect(playerPunish):
    ...
    if playerPunish <= 0:
        if blade == 3:
            checkInput = False
            while not checkInput:
                checkInput = plop(playerCurrent, player1name, player2name)  # asks input again
                break
            return playerPunish
        elif blade == 2:
            poke()
        ...
        checkInput = plop(playerCurrent, player1name, player2name)  # plops value and checks if row
    ...
    try:
        ...
        if answer == 1:                                                                 # starts game
                ...
                while game == True:                                                     # game loop
                    ...
                    switch = plop(playerCurrent, player1name, player2name)
                ...
                while not isSet:  # set loop
                    ...
                    if winsP1 == currentSetType or winsP2 == currentSetType:            # checks for a set win
                        if currentSetType == 2:
                            if playerCurrent == 1:
                                print(str(player1name) + " has won the " + STR_BO3 + "set!")  # prints winner BO3
                            if playerCurrent == 2:
                                print(str(player2name) + " has won the " + STR_BO3 + "set!")  # prints winner BO3

                        elif currentSetType == 3:
                            if playerCurrent == 1:
                                print(str(player1name) + " has won the " + STR_BO5 + "set!")  # prints winner BO3
                            if playerCurrent == 2:
                                print(str(player2name) + " has won the " + STR_BO5 + "set!")  # prints winner BO3
                    ...
                    while game:
                        ...
                        print(player1name + " has to wait " + str(punishP1) + " turns to use a blade!")
                        ...
                        print(player2name + " has to wait " + str(punishP2) + " turns to use a blade!")
            ...
            print("q: quit | names: change of names | blades")
